...
BatteryVoltage = data_source.Y(1,3).Data;
...
stairs(time, UCVoltageMeasurement, 'b', 'LineWidth', 3);
legend_text = [ legend_text {'BatteryVoltage'} ];
% legend_text = [ legend_text {'UCVoltageCommand'} ];
legend_text = [ legend_text {'UCVoltageMeasurement'} ];
legend(legend_text);
